...
<qgis simplifyDrawingHints="0" readOnly="0" hasScaleBasedVisibilityFlag="1" version="3.4.13-Madeira" styleCategories="AllStyleCategories" simplifyAlgorithm="2" maxScale="1" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="2501" simplifyLocal="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ffc313a8-9ac3-4c5b-b6fc-5bca3acca0b4}">
      <rule key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" filter="&quot;fnappaep&quot; = '01'" label="Point de branchement" symbol="0"/>
      <rule key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" filter="&quot;fnappaep&quot; = '02'" label="Ventouse" symbol="1"/>
      <rule key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" filter="&quot;fnappaep&quot; = '03'" label="Vanne" symbol="2"/>
      <rule key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" filter="&quot;fnappaep&quot; = '04'" label="Vidange" symbol="3"/>
      <rule key="{f792ae03-cef2-47fe-a398-e947a5d3ac87}" filter="&quot;fnappaep&quot; = '05'" label="Régulateur de pression" symbol="4"/>
      <rule key="{e76bb9a5-91cf-441f-8ae2-0bde942731cf}" filter="&quot;fnappaep&quot; = '06'" label="Hydrant" symbol="5"/>
      <rule key="{bdf8bbba-c9ad-4eb3-be24-6fb2caec848e}" filter="&quot;fnappaep&quot; = '07'" label="Compteur" symbol="6"/>
      <rule key="{331dec65-c9a4-4bef-b1d1-9a5ee54ae441}" filter="&quot;fnappaep&quot; = '08'" label="Débitmètre" symbol="7"/>
      <rule key="{4b66521e-4704-418d-902d-4a8d822c23cf}" filter="&quot;fnappaep&quot; = '99'" label="Autre" symbol="8"/>
      <rule key="{fae07b30-dab3-4869-a5d8-be27e1e6a3ee}" filter="&quot;fnappaep&quot; = '00'" label="Indéterminé" symbol="9"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" type="marker" name="0">
        <layer class="SimpleMarker" locked="0" pass="0" enabled="1">
          <prop k="angle" v="0"/>
          <prop k="color" v="201,37,37,255"/>
          ...
          <prop k="outline_color" v="123,123,123,255"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Layer" value="val_raepa_fonc_app_ae201910091036565361229466762"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="bool" name="UseCompleter" value="false"/>
  ...
  <aliases>
    ...
    <alias index="1" field="idappareil" name="Code appareil"/>
    ...
    <alias index="6" field="fnappaep" name="Fonction"/>
    <alias index="7" field="anfinpose" name="Année de fin de pose"/>
    <alias index="8" field="diametre" name="Diamètre nominal [mm]"/>
    <alias index="9" field="idcanamont" name="Canalisation amont"/>
    <alias index="10" field="idcanaval" name="Canalisation aval"/>
    <alias index="11" field="idcanppale" name="Canalisation principale"/>
    <alias index="12" field="idouvrage" name="Ouvrage d’accueil"/>
    <alias index="13" field="z" name="Altitude [m]"/>
    <alias index="14" field="andebpose" name="Année de début de pose"/>
    <alias index="15" field="qualglocxy" name="Qualité de la géolocalisation XY"/>
    <alias index="16" field="qualglocz" name="Qualité de la géolocalisation Z"/>
    <alias index="17" field="datemaj" name="Date de mise à jour"/>
    <alias index="18" field="sourmaj" name="Source de la mise à jour"/>
    <alias index="19" field="qualannee" name="Qualité de l’année de pose"/>
    <alias index="20" field="dategeoloc" name="Date de la géolocalisation"/>
    <alias index="21" field="sourgeoloc" name="Auteur de la géolocalisation"/>
    <alias index="22" field="sourattrib" name="Auteur des données attributaires"/>
    <alias index="23" field="_ferme" name="Fermeture appareil"/>
    <alias index="24" field="_orientation" name=""/>
    <alias index="25" field="_observation" name="Obsevation"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default field="id" expression="" applyOnUpdate="0"/>
    <default field="idappareil" expression="" applyOnUpdate="0"/>
    ...
    <default field="fnappaep" expression="" applyOnUpdate="0"/>
    <default field="anfinpose" expression="" applyOnUpdate="0"/>
    ...
    <default field="_ferme" expression="" applyOnUpdate="0"/>
    <default field="_orientation" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="1" field="idappareil" notnull_strength="1" exp_strength="0" constraints="3"/>
    <constraint unique_strength="0" field="x" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint unique_strength="0" field="y" notnull_strength="1" exp_strength="0" constraints="1"/>
    ...
    <constraint unique_strength="0" field="fnappaep" notnull_strength="1" exp_strength="0" constraints="1"/>
    ...
    <constraint unique_strength="0" field="idcanamont" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint unique_strength="0" field="idcanaval" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint unique_strength="0" field="idcanppale" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="idouvrage" notnull_strength="0" exp_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" field="_ferme" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint unique_strength="0" field="_orientation" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" field="_observation" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" exp="" desc=""/>
    <constraint field="idappareil" exp="" desc=""/>
    ...
    <constraint field="fnappaep" exp="" desc=""/>
    ...
    <constraint field="_ferme" exp="" desc=""/>
    <constraint field="_orientation" exp="" desc=""/>
    <constraint field="_observation" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
    <actionsetting action="from qgis.utils import plugins&#xa;plugins['raepa'].run_action(&#xa;    'parcourir_reseau_depuis_cet_objet',&#xa;    '[% idappareil %]',&#xa;    0&#xa;)" capture="0" isEnabledOnlyWhenEditable="0" type="1" id="{385848ec-fedf-4247-8e32-7d1287afbf67}" name="Parcourir le réseau depuis cet objet" shortTitle="" icon="" notificationMessage="">
      <actionScope id="Feature"/>
      <actionScope id="Field"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting action="from qgis.utils import plugins&#xa;plugins['raepa'].run_action(&#xa;    'calcul_orientation_appareil',&#xa;    '[% idappareil %]',&#xa;)" capture="0" isEnabledOnlyWhenEditable="0" type="1" id="{deb7f169-110b-45fb-bb06-d7e5a71738d7}" name="Calcul de l'orientation de l'appareil" shortTitle="" icon="" notificationMessage="">
      <actionScope id="Feature"/>
      <actionScope id="Field"/>
      <actionScope id="Canvas"/>
    </actionsetting>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" name="idappareil" hidden="0"/>
      ...
      <column width="-1" type="field" name="fnappaep" hidden="0"/>
      ...
      <column width="-1" type="field" name="_ferme" hidden="0"/>
      <column width="-1" type="field" name="_orientation" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" visibilityExpressionEnabled="0" showLabel="1" name="Appareil" columnCount="1" visibilityExpression="">
      <attributeEditorContainer groupBox="1" visibilityExpressionEnabled="0" showLabel="1" name="Général" columnCount="1" visibilityExpression="">
        ...
        <attributeEditorField index="25" showLabel="1" name="_observation"/>
      ...
      <attributeEditorContainer groupBox="1" visibilityExpressionEnabled="0" showLabel="1" name="Technique" columnCount="1" visibilityExpression="">
        ...
        <attributeEditorField index="23" showLabel="1" name="_ferme"/>
      </attributeEditorContainer>
