...
<qgis maxScale="1" simplifyLocal="0" minScale="2501" simplifyMaxScale="1" version="3.4.14-Madeira" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="2" readOnly="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{ffc313a8-9ac3-4c5b-b6fc-5bca3acca0b4}">
      <rule label="Point de branchement" filter="&quot;fnappaep&quot; = '01'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="0"/>
      <rule label="Ventouse" filter="&quot;fnappaep&quot; = '02'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="1"/>
      <rule label="Vanne" filter="&quot;fnappaep&quot; = '03'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="2"/>
      <rule label="Vidange" filter="&quot;fnappaep&quot; = '04'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="3"/>
      <rule label="Régulateur de pression" filter="&quot;fnappaep&quot; = '05'" key="{f792ae03-cef2-47fe-a398-e947a5d3ac87}" symbol="4"/>
      <rule label="Hydrant" filter="&quot;fnappaep&quot; = '06'" key="{e76bb9a5-91cf-441f-8ae2-0bde942731cf}" symbol="5"/>
      <rule label="Compteur" filter="&quot;fnappaep&quot; = '07'" key="{bdf8bbba-c9ad-4eb3-be24-6fb2caec848e}" symbol="6"/>
      <rule label="Débitmètre" filter="&quot;fnappaep&quot; = '08'" key="{331dec65-c9a4-4bef-b1d1-9a5ee54ae441}" symbol="7"/>
      <rule label="Autre" filter="&quot;fnappaep&quot; = '99'" key="{4b66521e-4704-418d-902d-4a8d822c23cf}" symbol="8"/>
      <rule label="Indéterminé" filter="&quot;fnappaep&quot; = '00'" key="{fae07b30-dab3-4869-a5d8-be27e1e6a3ee}" symbol="9"/>
    </rules>
    <symbols>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="'INCONNU'" field="idappareil"/>
    ...
    <default applyOnUpdate="0" expression="" field="fnappaep"/>
    <default applyOnUpdate="0" expression="-1" field="anfinpose"/>
    ...
    <default applyOnUpdate="0" expression="" field="_ferme"/>
    <default applyOnUpdate="0" expression="" field="_orientation"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="1" notnull_strength="1" constraints="3" exp_strength="0" field="idappareil"/>
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="x"/>
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="y"/>
    ...
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="fnappaep"/>
    ...
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="idcanamont"/>
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="idcanaval"/>
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="idcanppale"/>
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="idouvrage"/>
    ...
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="_ferme"/>
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="_orientation"/>
    <constraint unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0" field="_observation"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="idappareil"/>
    ...
    <constraint desc="" exp="" field="fnappaep"/>
    ...
    <constraint desc="" exp="" field="_ferme"/>
    <constraint desc="" exp="" field="_orientation"/>
    <constraint desc="" exp="" field="_observation"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
    <actionsetting notificationMessage="" isEnabledOnlyWhenEditable="0" id="{5c168116-0a77-4828-8333-7d4746a07bf6}" icon="" action="from qgis.utils import plugins&#xa;plugins['raepa'].run_action(&#xa;    'parcourir_reseau_depuis_cet_objet',&#xa;    '[% idappareil %]',&#xa;    0&#xa;)" shortTitle="" capture="0" name="Parcourir le réseau depuis cet objet" type="1">
      <actionScope id="Canvas"/>
      <actionScope id="Field"/>
      <actionScope id="Feature"/>
    </actionsetting>
    <actionsetting notificationMessage="" isEnabledOnlyWhenEditable="0" id="{456f9dcd-0c37-4f1f-a9f3-c0081ed46137}" icon="" action="from qgis.utils import plugins&#xa;plugins['raepa'].run_action(&#xa;    'calcul_orientation_appareil',&#xa;    '[% idappareil %]',&#xa;)" shortTitle="" capture="0" name="Calcul de l'orientation de l'appareil" type="1">
      <actionScope id="Canvas"/>
      <actionScope id="Field"/>
      <actionScope id="Feature"/>
    </actionsetting>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" name="idappareil" hidden="0" type="field"/>
      ...
      <column width="-1" name="fnappaep" hidden="0" type="field"/>
      ...
      <column width="-1" name="_ferme" hidden="0" type="field"/>
      <column width="-1" name="_orientation" hidden="0" type="field"/>
