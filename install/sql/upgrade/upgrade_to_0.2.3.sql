...
DROP FUNCTION IF EXISTS raepa.get_canalisation_id_by_object_id(text);
CREATE OR REPLACE FUNCTION raepa.get_canalisation_id_by_object_id(p_id_object text, p_direction text)
RETURNS text[]
LANGUAGE plpgsql
AS
$$
