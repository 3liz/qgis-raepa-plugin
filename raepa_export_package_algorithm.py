...
class RaepaExportPackageAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    def name(self):
        return 'raepa_export_package'

    def displayName(self):
        return self.tr('Exporter les données dans un seul fichier')
    ...
    def createInstance(self):
        return RaepaExportPackageAlgorithm()
