...
class GetNetworkToVanneFromPoint(GetDataAsLayer):
    """
    ...
    def name(self):
        return 'get_network_to_vanne_from_point'

    def displayName(self):
        return 'Parcours réseau jusqu\'aux vannes depuis un point'
    ...
    def setSql(self, parameters, context, feedback):
        ...
        sql = '''
        SELECT 1 AS id, c.idcana, ST_Line_Locate_Point(c.geom, p.geom) as loc, ST_Distance(c.geom, p.geom) as dist, raepa.get_network_to_vanne_from_point(c.idcana, ST_Line_Locate_Point(c.geom, p.geom)) AS geom
