...
<qgis maxScale="1" simplifyLocal="0" minScale="2501" simplifyMaxScale="1" version="3.4.14-Madeira" simplifyDrawingHints="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="2" readOnly="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{ffc313a8-9ac3-4c5b-b6fc-5bca3acca0b4}">
      <rule label="Point de branchement" filter="&quot;fnappass&quot; = '01'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="0"/>
      <rule label="Ventouse" filter="&quot;fnappass&quot; = '02'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="1"/>
      <rule label="Vanne" filter="&quot;fnappass&quot; = '03'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="2"/>
      <rule label="Débitmètre" filter="&quot;fnappass&quot; = '04'" key="{bbe1ad90-e303-4f18-aa85-097f0ab6e914}" symbol="3"/>
      <rule label="Autre" filter="&quot;fnappass&quot; = '99'" key="{e5bbc799-db92-402a-9dda-e0d53c7f8e6b}" symbol="4"/>
      <rule label="Purge" filter="&quot;fnappass&quot; = '_1'" key="{91218396-1e67-42e1-9582-363603c84310}" symbol="5"/>
      <rule label="Non défini" filter="&quot;fnappass&quot; = ''" key="{c5bd8df6-ed40-49f1-9bef-2a02f7019430}" symbol="6"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    <property key="dualview/previewExpressions" value="COALESCE( &quot;idappareil&quot;, '&lt;NULL>' )"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" type="QString" value=""/>
            <Option name="Key" type="QString" value="code"/>
            <Option name="Layer" type="QString" value="val_raepa_fonc_app_ass201910091036565361879483657"/>
            <Option name="NofColumns" type="int" value="1"/>
            <Option name="OrderByValue" type="bool" value="true"/>
            <Option name="UseCompleter" type="bool" value="false"/>
            <Option name="Value" type="QString" value="libelle"/>
  ...
  <aliases>
    ...
    <alias index="7" field="fnappass" name="Fonction"/>
    <alias index="8" field="andebpose" name="Année de début de pose"/>
    <alias index="9" field="anfinpose" name="Année de fin de pose"/>
    <alias index="10" field="diametre" name="Diamètre nominal [mm]"/>
    <alias index="11" field="idcanamont" name="Canalisation amont"/>
    <alias index="12" field="idcanaval" name="Canalisation aval"/>
    <alias index="13" field="idcanppale" name="Canalisation principale"/>
    <alias index="14" field="idouvrage" name="Ouvrage d’accueil"/>
    <alias index="15" field="z" name="Altitude [m]"/>
    ...
    <alias index="24" field="_source_historique" name=""/>
    <alias index="25" field="_code_chantier" name="Code du chantier"/>
    <alias index="26" field="_date_import" name="Date de l'import"/>
    <alias index="27" field="_temp_data" name=""/>
    <alias index="28" field="_observation" name="Observation"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="fnappass"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0" field="fnappass"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="fnappass"/>
  ...
  <attributeactions>
    ...
    <actionsetting notificationMessage="" isEnabledOnlyWhenEditable="0" id="{cdf8515d-8312-48ed-8d1a-786a6c728c98}" icon="" action="from qgis.utils import plugins&#xa;plugins['raepa'].run_action(&#xa;    'parcourir_reseau_depuis_cet_objet',&#xa;    '[% idappareil %]',&#xa;    0&#xa;)" shortTitle="" capture="0" name="Parcourir le réseau depuis cet objet" type="1">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" name="fnappass" hidden="0" type="field"/>
      ...
      <column width="-1" name="_source_historique" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpression="" visibilityExpressionEnabled="0" columnCount="1" groupBox="0" name="Appareil">
      <attributeEditorContainer showLabel="1" visibilityExpression="" visibilityExpressionEnabled="0" columnCount="1" groupBox="1" name="Général">
        ...
        <attributeEditorField showLabel="1" index="7" name="fnappass"/>
        <attributeEditorField showLabel="1" index="28" name="_observation"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpression="" visibilityExpressionEnabled="0" columnCount="1" groupBox="1" name="Technique">
        ...
        <attributeEditorField showLabel="1" index="15" name="z"/>
        <attributeEditorField showLabel="1" index="10" name="diametre"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpression="" visibilityExpressionEnabled="0" columnCount="1" groupBox="1" name="Relations">
        <attributeEditorField showLabel="1" index="11" name="idcanamont"/>
        <attributeEditorField showLabel="1" index="12" name="idcanaval"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpression="" visibilityExpressionEnabled="0" columnCount="1" groupBox="1" name="Historique">
        ...
        <attributeEditorField showLabel="1" index="8" name="andebpose"/>
        <attributeEditorField showLabel="1" index="9" name="anfinpose"/>
      </attributeEditorContainer>
  ...
  <widgets/>
  <previewExpression>COALESCE( "idappareil", '&lt;NULL>' )</previewExpression>
  <mapTip></mapTip>
